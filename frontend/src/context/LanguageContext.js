...
const translations = {
  sv: {
    ...
    classes: {
      ...
      deadlinePassed: 'Bokning stängd',
      deadlinePassedTitle: 'Bokning stängde {hours} timmar innan passet',
    ...
    admin: {
      ...
      bookingDeadline: 'Bokningsdeadline (timmar)',
      bookingDeadlineHelp: 'Antal timmar innan passet som bokning/avbokning stänger. 0 = ingen deadline.',
      classUpdated: 'Passet har uppdaterats!',
      classCreated: 'Nytt pass har skapats!',
      classesCreated: '{count} pass har skapats!',
      classDeleted: 'Passet har tagits bort!',
      additionalDates: 'Lägg till fler datum (valfritt)',
      addDate: 'Lägg till datum',
      totalClassesInfo: 'Totalt {count} pass kommer att skapas',
  ...
  en: {
    ...
    classes: {
      ...
      classPassed: 'Passed',
      deadlinePassed: 'Booking closed',
      deadlinePassedTitle: 'Booking closed {hours} hours before class',
    ...
    admin: {
      ...
      bookingDeadlineHelp: 'Hours before class when booking/cancellation closes. 0 = no deadline.',
      ...
      additionalDates: 'Add more dates (optional)',
      addDate: 'Add date',
      totalClassesInfo: 'Total {count} classes will be created',
