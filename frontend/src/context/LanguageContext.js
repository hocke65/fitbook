...
const translations = {
  sv: {
    ...
    myBookings: {
      ...
      pastTab: 'Historik',
      pastBookings: 'passerade bokningar',
      noPastBookings: 'Ingen bokningshistorik',
      attended: 'Deltog',
      completed: 'Genomfört',
    },
    // Admin
    admin: {
      ...
      roleSuperuserOption: 'Superuser (passhanterare)',
  ...
  en: {
    ...
    admin: {
      ...
      roleUser: 'User',
      roleSuperuser: 'Superuser',
      roleSuperuserOption: 'Superuser (class manager)',
